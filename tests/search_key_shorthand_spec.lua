...
-- Stubs for the Neovim API used by jira.api
local captured_calls = {}
local success_body = [[{"issues":[{"key":"SPL-106","fields":{"summary":"Multi Directory with multi type configuration","status":{"name":"Done"}}}],"total":1,"startAt":0,"maxResults":50,"nextPageToken":"next-shorthand"}]]
